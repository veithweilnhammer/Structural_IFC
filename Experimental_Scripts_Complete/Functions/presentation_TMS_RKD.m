...
function [Results] = presentation_TMS_RKD(root_dir, SettingsName, ObserverName, BlueValue, session, transition_probability)
...
%[w, rect] = Screen('OpenWindow', screenNumber, 0,[1920 0 2*1920 1080], 32, doublebuffer+1, [], 128); % double landscape
%[w, rect] = Screen('OpenWindow', screenNumber, 0,[1920 0 1920+1400 1050], 32, doublebuffer+1, [], 128); % Samtron Lab 2
[w, rect] = Screen('OpenWindow', screenNumber, 0,[], 32, doublebuffer+1, [], 128); % EEG / TMS
%[w, rect] = Screen('OpenWindow', screenNumber, 0,[0 0 900 900], 32, doublebuffer+1, [], 128); % debugging
%[w, rect] = Screen('OpenWindow', screenNumber, 0,[], 32, doublebuffer+1, [], 128); % full screen
